            ...
            <div className="bg-white rounded mt-120 mb-20 mx-30">
                ...
                <ul className="w-full lg:w-1/2">
                  <li className="flex justify-center">
                    <button type="button" className="bg-brown-light border border-brown-dark rounded text-brown-dark font-mPlus font-semibold text-xl w-full lg:w-11/12 py-22 my-10 mx-20 lg:mt-20 ">
                      <Link href={"./search/searchline"} className='hover:text-brown'>路線・駅から探す</Link>
                    </button>
                  </li>
                  <li className="flex justify-center">
                    <button type="button" className="bg-brown-light border border-brown-dark rounded text-brown-dark font-mPlus font-semibold text-xl w-full lg:w-11/12 py-22 my-10 mx-20 lg:mt-10">
                      <Link href={"./search/searchprice"} className='hover:text-brown'>相場価格から探す</Link>
                    </button>
                  </li>
                  <li className="flex justify-center">
                    <button type="button" className="bg-brown-light border border-brown-dark rounded text-brown-dark font-mPlus font-semibold text-xl w-full lg:w-11/12 py-22 my-10 mb-20 mx-20 lg:mt-9">
                      <Link href={"/condition"} className='hover:text-brown'>詳細検索</Link>
                    </button>
              ...
              <div className="flex w-full h-auto font-mPlus font-semibold text-brown-dark my-10">
                <div className="flex flex-col justify-center text-center bg-white rounded text-sm lg:text-xl w-5/12 lg:w-1/2 h-auto ml-30">
                  ...
                  <div className="text-xxs lg:text-base">これまでにリノベーションされた<br/>建物の一例を紹介！</div>
                  <div className="flex justify-center z-10">
                    <div className="w-auto h-auto">
                      <button className='mt-10 mb-10 lg:mx-40 px-10 lg:px-12 py-5 rounded-full whitespace-nowrap bg-brown-dark text-white text-xs lg:text-lg'>
                        <Link href={"/example"} className='hover:text-brown'>詳細を見る</Link>
                      </button>
                    </div>
                ...
                <div className="flex flex-col justify-center text-center bg-white rounded text-sm lg:text-xl w-5/12 lg:w-1/2 h-auto ml-10 lg:ml-20 mr-30">
                  ...
                  <div className="text-xxs lg:text-base">リノベーション経験者の話を<br/>聞くならココ！</div>
                  <div className="flex justify-center z-10">
                    <div className="w-auto h-auto">
                      <button className='mt-10 mb-10 lg:mx-40 px-10 lg:px-12 py-5 justify-center rounded-full whitespace-nowrap bg-brown-dark text-white text-xs lg:text-lg'>
                        <Link href={'/consult'} className='hover:text-brown'>詳細を見る</Link>
                      </button>
                    </div>
                    {/* <div className="relative w-35 h-35 lg:w-55 lg:h-55">
              ...
              <div className="flex w-full h-auto font-mPlus font-semibold text-brown-dark my-10 mb-20">
                <div className="flex flex-col justify-center text-center bg-white rounded text-sm lg:text-xl w-5/12 lg:w-1/2 h-auto ml-30">
                  ...
                  <div className="text-xxs lg:text-base">小倉に住むって<br/>一体どんな感じ？</div>
                  <div className="w-auto h-auto">
                    <button className='mt-10 mb-10 lg:mx-40 px-10 lg:px-12 py-5 rounded-full whitespace-nowrap bg-brown-dark text-white text-xs lg:text-lg'>
                ...
                <div className="flex flex-col justify-center text-center bg-white rounded text-sm lg:text-xl w-5/12 lg:w-1/2 h-auto ml-10 lg:ml-20 mr-30">
                  ...
                  <div className="text-xxs lg:text-base">小倉に住む上での魅力を<br/>たっぷりご紹介！</div>
                  <div className="w-auto h-auto">
                    <button className='mt-10 mb-10 lg:mx-40 px-10 lg:px-12 py-5 rounded-full whitespace-nowrap bg-brown-dark text-white text-xs lg:text-lg'>
                      <div className='hover:text-brown'>詳細を見る</div>
                    </button>
